...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCoordinatorLayout = findViewById(R.id.coordinator_layout_article_list);
    ...
    private BroadcastReceiver mRefreshingReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ((UpdaterService.BROADCAST_ACTION_STATE_CHANGE.equals(intent.getAction()))&&(mIsRefreshing)) {
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        Snackbar snackbar = Snackbar
                .make(mCoordinatorLayout, "Data loading completed !", Snackbar.LENGTH_LONG);
        snackbar.show();
    }
